...
(function () {
    ...
    Renderer.prototype.emoji = function (emoji) {
        // console.log(emoji);
        return `<img src="http://twemoji.maxcdn.com/2/72x72/${emoji}.png" title="twemoji-${emoji}" alt="twemoji-${emoji}" class="emoji twemoji">`;
    };

    Renderer.prototype.formula = function (formula) {  
        var renderFormula = formula.substring(1, formula.length - 1);
        var html = katex.renderToString(renderFormula);
        console.log(formula);
        return html;
    };
